				...
				<div className="">
					...
					<div className="me-12 space-y-4 rounded-lg p-8 shadow-lg">
						...
						<textarea
							...
							className="w-full border border-gray-300 p-4"></textarea>

						<button className="bg-earth-light hover:bg-earth-dark rounded-sm px-8 py-2 text-xl text-white uppercase">
							Send Now
						</button>
					</div>
				</div>
